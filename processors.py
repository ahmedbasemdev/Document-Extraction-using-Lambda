...
class RotationCorrector:
    ...
    def __call__(self, image):
        ...
        img_rotated = cv2.warpAffine(img_before, M, (w, h), borderMode=cv2.BORDER_CONSTANT, borderValue=(255,255,255))
...
class Closer:
    def __init__(self, kernel_size = 5, iterations = 5, output_process = False):
...
class EdgeDetector:
    ...
    def __call__(self, image, thresh1 = 50, thresh2 = 200, apertureSize = 3):
        image = cv2.cvtColor(image, cv2.COLOR_BGR2GRAY)
